...
class Sensormaster(models.Model):
    ...
    sensorname = models.CharField(max_length=50, blank=True, null=True)
    companyid = models.ForeignKey(Companymaster, on_delete=models.CASCADE, db_column='companyid')
    sensortypeid = models.ForeignKey(Sensortypemaster, on_delete=models.CASCADE, db_column='sensortypeid', blank=True, null=True)
...
class Usermaster(models.Model):
    ...
    company = models.ForeignKey(Companymaster,on_delete=models.CASCADE,db_column='companyid')
...
class Zonemaster(models.Model):
    ...
    latitude = models.CharField(max_length=20, blank=True, null=True)
    longitude = models.CharField(max_length=20, blank=True, null=True)
    zoneimagepath = models.CharField(max_length=255, blank=True, null=True)
