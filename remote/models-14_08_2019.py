...
class Objectsensormapping(models.Model):
    ...
    sensorid = models.ForeignKey('Sensormaster', on_delete=models.CASCADE, db_column='sensorid')
    workflowid = models.ForeignKey('Workflowmaster', on_delete=models.CASCADE, db_column='workflowid', blank=True, null=True)
    ...
    createddate = models.DateTimeField(auto_now_add=True,blank=True, null=True)
    updateddate = models.DateTimeField(auto_now=True,blank=True, null=True)
    companyid = models.ForeignKey(Companymaster, on_delete=models.CASCADE, db_column='companyid')
    objecttypeid = models.ForeignKey('Objecttypemaster', on_delete=models.CASCADE, db_column='objecttypeid', blank=True, null=True)
...
class Objecttransaction(models.Model):
    ...
    sensorname = models.CharField(max_length=255, blank=True, null=True)
    objectid = models.IntegerField(blank=True, null=True)
    objectname = models.CharField(max_length=255, blank=True, null=True)
    zonename = models.CharField(max_length=255, blank=True, null=True)
    companyid = models.IntegerField(blank=True, null=True)
    param1 = models.DecimalField(max_digits=150, decimal_places=2, blank=True, null=True)
    param2 = models.DecimalField(max_digits=150, decimal_places=2, blank=True, null=True)
    param3 = models.DecimalField(max_digits=150, decimal_places=2, blank=True, null=True)
    param4 = models.DecimalField(max_digits=150, decimal_places=2, blank=True, null=True)
    param5 = models.DecimalField(max_digits=150, decimal_places=2, blank=True, null=True)
    ...
    sensorid = models.CharField(max_length=100, blank=True, null=True)
    zoneid = models.CharField(max_length=100, blank=True, null=True)
    param6 = models.DecimalField(max_digits=200, decimal_places=2, blank=True, null=True)
    entrydatetime = models.DateTimeField(auto_now_add=True,blank=True, null=True)
...
class Objecttypemaster(models.Model):
    ...
    objecttypename = models.CharField(max_length=255, blank=True, null=True)
...
class Objectzonedetails(models.Model):
    objectid = models.ForeignKey(Objectsensormapping, on_delete=models.CASCADE, db_column='objectid', primary_key=True)
    objectname = models.CharField(max_length=255, blank=True, null=True)
    zoneid = models.CharField(max_length=100, blank=True, null=True)
    zonename = models.CharField(max_length=255, blank=True, null=True)
    companyid = models.ForeignKey(Companymaster, on_delete=models.CASCADE, db_column='companyid', blank=True, null=True)
    updateddatetime = models.DateTimeField(blank=True, null=True)
    sensorid = models.CharField(max_length=200, blank=True, null=True)
    paramvalues = models.TextField(blank=True, null=True)  # This field type is a guess.
    zoneentrydatetime = models.DateTimeField(auto_now_add=True,blank=True, null=True)
    objecttypeid = models.ForeignKey(Objecttypemaster, on_delete=models.CASCADE, db_column='objecttypeid', blank=True, null=True)
...
class Sensormaster(models.Model):
    ...
    sensorname = models.CharField(max_length=255, blank=True, null=True)
    companyid = models.ForeignKey('Companymaster', on_delete=models.CASCADE, db_column='companyid')
    sensortypeid = models.ForeignKey('Sensortypemaster', on_delete=models.CASCADE, db_column='sensortypeid')
    paramtype1 = models.CharField(max_length=200, blank=True, null=True)
    paramtype2 = models.CharField(max_length=200, blank=True, null=True)
    paramtype3 = models.CharField(max_length=200, blank=True, null=True)
    paramtype4 = models.CharField(max_length=200, blank=True, null=True)
    paramtype5 = models.CharField(max_length=200, blank=True, null=True)
    activesensor = models.CharField(max_length=1)
    createddate = models.DateTimeField(auto_now_add=True,blank=True, null=True)
    updateddate = models.DateTimeField(auto_now=True,blank=True, null=True)
    paramtype6 = models.CharField(max_length=200, blank=True, null=True)
...
class Sensortypemaster(models.Model):
    ...
    sensortypename = models.CharField(max_length=255, blank=True, null=True)
    createddate = models.DateTimeField(auto_now_add=True,blank=True, null=True)
    updateddate = models.DateTimeField(auto_now=True,blank=True, null=True)
    companyid = models.ForeignKey(Companymaster, on_delete=models.CASCADE, db_column='companyid')
...
class Usermaster(models.Model):
    ...
    userfullname = models.CharField(max_length=255, blank=True, null=True)
    companyid = models.ForeignKey(Companymaster, on_delete=models.CASCADE, db_column='companyid')
...
class Workflowmaster(models.Model):
    ...
    workflowname = models.CharField(max_length=255, blank=True, null=True)
    zonedetails = models.TextField(blank=True, null=True)  # This field type is a guess.
    finalzoneid = models.CharField(max_length=100, blank=True, null=True)
    companyid = models.ForeignKey(Companymaster, on_delete=models.CASCADE, db_column='companyid')
...
class Zonemaster(models.Model):
    ...
    zoneimagepath = models.TextField(blank=True, null=True)
